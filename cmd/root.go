...
import (
	"log"
	"os"
	"smarttask-cli/internal/config"
	"smarttask-cli/internal/repository"
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.smarttask-cli.yaml)")
